        ...
        <div class="main-left col-span-3 space-y-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4">
                <div class="p-4 text-center bg-gray-100 rounded-lg">
                    ...
                    <p><strong>MuchieCodes</strong></p>

                    <div class="mt-6 flex space-x-8 justify-around">
                        <p class="text-xs text-gray-500">182k friends</p>
                        <p class="text-xs text-gray-500">1400 posts</p>
                    </div>
                </div>
                ...
                <div class="p-4 text-center bg-gray-100 rounded-lg">
                    ...
                    <p><strong>Code With Glex</strong></p>

                    <div class="mt-6 flex space-x-8 justify-around">
                        <p class="text-xs text-gray-500">100k friends</p>
                        <p class="text-xs text-gray-500">1200 posts</p>
                    </div>
                </div>
                ...
                <div class="p-4 text-center bg-gray-100 rounded-lg">
                    ...
                    <p><strong>Jacob Elrodi</strong></p>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        ...
                        <p><strong>Sydney Sweeney</strong></p>
                    </div>
