...
export default {
  ...
  methods: {
    submitForm() {
      ...
      } else if (!this.isPasswordValid(this.form.password1)) {
        this.errors.push('Password must be at least 8 characters long and include at least one uppercase letter and one symbol')
      }
